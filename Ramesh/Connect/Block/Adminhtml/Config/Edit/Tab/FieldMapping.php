<?php
namespace  Ramesh\Connect\Block\Adminhtml\Config\Edit\Tab;
...
class FieldMapping extends \Magento\Backend\Block\Widget implements TabInterface
{
    ...
    public function __construct(
        ...
        \Ramesh\Connect\Model\EnitytypeAttribute $EnitytypeAttribute,
        array $data = []
    ) {
        $this->_coreRegistry = $registry;
        $this->_model = $this->_coreRegistry->registry('rameshconnect_entitytype');
