...
{
    const ADMIN_RESOURCE = 'Ramesh_Connect::save';
    /**
     * Core registry
     *
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Ramesh_Connect::config')
            ->addBreadcrumb(__('Ramesh_Connect'), __('Ramesh_Connect'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Ramesh\Connect\Model\EntityType');
        ...
        $this->_coreRegistry->register('rameshconnect_entitytype', $model);
